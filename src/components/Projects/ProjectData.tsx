...
export const projectData = [
  ...
  },
  {
    ...
    description: "Rust is often a great language to use in scenarios where C and C++ are appropriate. Most legacy systems build for C/C++ support first. The Rust exosystem makes it very easy to call Rust code from a C program, or to call C code from a Rust program. This program implements this in a simple linear algebra crate I wrote as part of another project and shows how you can call one program from another.",
    githubLink: "N/A",
    course: "339R (Advanced Programming Language (Rust))",
    featured: true,
  },
